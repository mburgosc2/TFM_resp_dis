...
def main():
    ...
    if args.mode == 'random':
        ...
        df_dev, df_test_base = train_test_split(
            ...
            test_size=0.15,
            random_state=42,
            stratify=df_metadata_unified[target_col]
        )
    ...
    for fold_idx, (train_idx, val_idx) in enumerate(skf.split(df_train, df_train[target_col])):
        df_train.loc[val_idx, 'fold'] = fold_idx

    # Guardar resultados con nombres dedicados multiclase
    PATH_OUT_TRAIN = r"C:\Users\Usuario\Desktop\UNI MARINA\master\TFM\TFM_resp_dis\metadata_train_multiclass_4c.csv"
    PATH_OUT_VAL = r"C:\Users\Usuario\Desktop\UNI MARINA\master\TFM\TFM_resp_dis\metadata_val_multiclass_4c.csv"
    PATH_OUT_TEST = r"C:\Users\Usuario\Desktop\UNI MARINA\master\TFM\TFM_resp_dis\metadata_test_multiclass_4c.csv"
    ...
    print("\n📊 Resumen del desglose por clases en TRAIN (cough_type_label):")
    print(df_train[target_col].value_counts().sort_index())

    print("\n📊 Resumen del desglose por clases en VALIDACIÓN (cough_type_label):")
    print(df_val[target_col].value_counts().sort_index())

    print("\n📊 Resumen del desglose por clases en TEST (cough_type_label):")
    print(df_test[target_col].value_counts().sort_index())
