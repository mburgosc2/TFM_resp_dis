...
PATH_FEATURES_DIR = r"C:\Users\Usuario\Desktop\UNI MARINA\master\TFM\TFM_resp_dis\features_extracted_wavelets_4c"


print("=" * 80)
print(" Loading Pre-extracted Features (.npy files) - XGBOOST GRID SEARCH...")
print("=" * 80)
...
# =====================================================================
# ⚖️ FASE 2: NORMALIZACIÓN ESTRICTA Z-SCORE
# =====================================================================
...
# =====================================================================
# 🔍 FASE 3: GRID SEARCH DE HIPERPARÁMETROS PARA XGBOOST (5-FOLDS)
# =====================================================================
print("\n" + "=" * 80)
...
print("\n" + "=" * 80)
print(f" 🏆 MEJORES HIPERPARÁMETROS XGBOOST (Macro F1 CV: {best_score:.4f}):")
...
# =====================================================================
# 🎯 FASE 4: ENTRENAMIENTO MODELO ÓPTIMO Y EVALUACIÓN FINAL EN TEST
# =====================================================================
print("\n ENTRENANDO MODELO XGBOOST ÓPTIMO SOBRE TODO TRAIN...")

sample_weights_train = compute_sample_weight('balanced', y_train)

xgb_best = XGBClassifier(
    n_estimators=200,             # Aumentado ligeramente para el ajuste fino final
...
# =====================================================================
print("\n" + "=" * 80)
print(" REPORTE DETALLADO POR CLASE EN TEST SET (XGBOOST OPTIMIZADO)")
print("=" * 80)
...
print("\n" + "=" * 80)
print(" Pipeline XGBoost Grid Search terminado.")
print("=" * 80)